...
class VolumeManager(manager.SchedulerDependentManager):
    ...
    def modify_type(self, ctxt, volume_id, type_id):
        ...
        new_reservations = self._check_new_type_quotas(context,
                                                       volume_id,
                                                       type_id)
        ...
        try:
            ...
            LOG.exception(_("Volume %s: error tyring to retype"),
                          volume_ref['id'])
            try:
                self.db.volume_update(context, volume_ref['id'],
                ...
                raise exception.VolumeBackendDriverException(
                    driver_name=self.driver.__name__)
